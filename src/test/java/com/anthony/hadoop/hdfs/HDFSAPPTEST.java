package com.anthony.hadoop.hdfs;
...
public class HDFSAPPTEST {
    ...
    //这里可以写远程的hdfs路径 把localhost设置为ip地址即可
    ...
    public void setUp() throws Exception{
        ...
        configuration = new Configuration();    //这里可以传入用户名，我使用的是Mac本机上的hadoop，用户名是一样的，如果不是，需要传入用户名参数
    ...
    public void mkdir()throws Exception{
        fileSystem.mkdirs(new Path("/hdfsapi/test22"));
    }
